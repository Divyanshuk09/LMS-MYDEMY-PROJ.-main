    ...
    <>
      <div className="py-10 md:px-40 px-8 flex flex-col justify-center items-center">
        ...
        <div className="flex gap-5 mt-5">
          <button className="cursor-pointer bg-blue-600 hover:bg-blue-500 font-semibold text-white md:px-9 px-4 md:py-3 py-1 rounded text-sm ">
            Get Started
          </button>
          <button className="cursor-pointer hover:text-blue-600 font-semibold flex items-center gap-2 group transition-all">
            Learn More
