      ...
      <div className="py-10 md:px-40 px-8 ">
        ...
        <div className="grid grid-cols-[repeat(auto-fit,_minmax(200px,_1fr))] px-4 md:px-0 md:my-16 my-10 gap-4  ">
          {dummyTestimonial.map((testimonials, index) => (
            <div
              className={` ${
                isDark ? "bg-gray-500/10" : "bg-white"
              } text-sm text-left border border-gray-500/30 pb-6 rounded-lg  shadow-[0px_4px_15px_0px] overflow-hidden shadow-black/5`}
              key={index}
            >
              <div className="flex items-center gap-4 md:px-5 px-4 md:py-4 py-2 bg-gray-500/10 ">
                ...
                <div className="flex flex-col">
                  <h1 className="md:text-lg text-xs font-medium text-gray-500">
                    {testimonials?.name}
                  </h1>
                  <p className="text-gray-700 md:text-base text-[10px]">
                    {testimonials?.role}
                  </p>
                </div>
              </div>
              <div className="p-5 pb-7">
                ...
                <p className="text-gray-500 mt-5 text-xs md:text-[14px] text-balance">
