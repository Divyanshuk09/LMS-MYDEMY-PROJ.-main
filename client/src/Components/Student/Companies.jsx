...
const Companies = () => {
  return (
    <>
<div className='pt-16'>
  <p className="md:text-3xl text-lg  font-medium text-gray-800">Trusted by learners from</p>
  <div className='flex flex-wrap items-center justify-center gap-6 md:gap-8 md:mt-5 mt-5 max-w-2xl'>
    <img src={MicroSoft}  alt="MicroSoft log" className='w-30 md:w-35' />
